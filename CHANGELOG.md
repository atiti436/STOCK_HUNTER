...
- `WATCHLIST` 配置區塊：個人口袋名單
  - 鈞興-KY (4571)：買進價位 150/140/130，目標 228
  - 南亞科 (2408)：停損 172，停利 200/220/230

- `check_watchlist_alerts()`: 檢查到價提醒
- `format_watchlist_alerts()`: 格式化提醒訊息
- 整合到 `scan_all_stocks()`: Step 3.5 追蹤清單檢查
- 整合到 `format_line_messages()`: LINE 推送包含追蹤清單提醒
